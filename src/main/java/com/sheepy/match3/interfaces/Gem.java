...
public interface Gem {
    ...
    /**
     * Natural ordering of gems, lower gems come before higher gems, from left to right.
     *
     * @param other The gem to compared with
     * @return -1 if the other gem is above or on the level and to the right of this gem,
     * 0 if the other gem is at the same position as this gem,
     * 1 if the other gem is below or on the level to the left of this gem.
     */
